...
//	for (i=(MMU_RESERVED2_START>>20); i<(MMU_MEM_AREA1_START>>20); i++) {
	//	addr[i] = 0x00000000;
//	}

	/* mapping system memory to 0xc4000000 */
	for (i=(MMU_MEM_AREA1_START>>20); i<(MMU_RESERVED3_START>>20); i++) {
		addr[i] = SECTION_ENTRY((i-(0xc40-0x380)),3,0,1,1);
	}
       /* disabled */
    for (i=(MMU_RESERVED3_START>>20); i<0x1000; i++) {
        addr[i] = 0x00000000;
    }
