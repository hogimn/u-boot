...
#define CONFIG_SMDS2450		1		/* on a SAMSUNG SMDS2450 Board  */

#define MEMORY_BASE_ADDRESS	0x30000000
#define MEMORY_BASE_ADDRESS_1	0x38000000

/* input clock of PLL */
#define CONFIG_SYS_CLK_FREQ	12000000	/* the SMDS2450 has 12MHz input clock */
...
/************************************************************
 * LED	- 4 leds glow while booting up
 ************************************************************/
#if 1
#define CONFIG_BOOTING_LED
#endif
...
#define CFG_PROMPT		"skw2450# "	/* Monitor Command Prompt	*/
