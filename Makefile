...
hkdkc210_android_config:	unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa9 hkdkc210 samsung s5pc210

sm5s4210_android_config:	unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa9 sm5s4210 samsung s5pc210
#########################################################################
## XScale Systems
#########################################################################
