...
#else
#define ELFIN_DMA_BASE			0x12680000
#define ELFIN_LCD_BASE			0x11C00000
#define ELFIN_USB_HOST_BASE		0x12580000
//#define DMA_BASE			0x12680000
//#define LCD0_BASE			0x11C00000
//#define LCD1_BASE			0x12000000
//#define USB_HOST_BASE			0x12580000
#endif
...
#else
#define ELFIN_I2S_BASE			0x13960000
#define ELFIN_ADC_BASE			0x13910000
#define ELFIN_SPI_BASE			0x13920000
//#define I2S_BASE			0x13960000
//#define ADC_BASE			0x13910000
//#define SPI_BASE			0x13920000
#endif
...
/* GPIO (Chapter 6) */
//JNJ #define ELFIN_GPIO_BASE			0xE0200000
...
#define GPE2CON_OFFSET 			0x120 
#define GPE2DAT_OFFSET 			0x124 
#define GPE2PUD_OFFSET 			0x128 
#define GPE2DRV_SR_OFFSET 		0x12C 
#define GPE2CONPDN_OFFSET 		0x130 
#define GPE2PUDPDN_OFFSET 		0x134 
...
#define GPE4CON_OFFSET 			0x160 
#define GPE4DAT_OFFSET 			0x164 
#define GPE4PUD_OFFSET 			0x168 
#define GPE4DRV_SR_OFFSET 		0x16C 
#define GPE4CONPDN_OFFSET 		0x170 
#define GPE4PUDPDN_OFFSET 		0x174 
...
#define GPJ0CON_OFFSET 			0x000 
#define GPJ0DAT_OFFSET 			0x004 
#define GPJ0PUD_OFFSET 			0x008 
#define GPJ0DRV_SR_OFFSET 		0x00C 
#define GPJ0CONPDN_OFFSET 		0x010 
#define GPJ0PUDPDN_OFFSET 		0x014 

#define GPJ1CON_OFFSET 			0x020 
#define GPJ1DAT_OFFSET 			0x024 
#define GPJ1PUD_OFFSET 			0x028 
#define GPJ1DRV_SR_OFFSET 		0x02C 
#define GPJ1CONPDN_OFFSET 		0x030 
#define GPJ1PUDPDN_OFFSET 		0x034 

#define GPK0CON_OFFSET 			0x040 
#define GPK0DAT_OFFSET 			0x044 
#define GPK0PUD_OFFSET 			0x048 
#define GPK0DRV_SR_OFFSET 		0x04C 
#define GPK0CONPDN_OFFSET 		0x050 
#define GPK0PUDPDN_OFFSET 		0x054 

#define GPK1CON_OFFSET 			0x060 
#define GPK1DAT_OFFSET 			0x064 
#define GPK1PUD_OFFSET 			0x068 
#define GPK1DRV_SR_OFFSET 		0x06C 
#define GPK1CONPDN_OFFSET 		0x070 
#define GPK1PUDPDN_OFFSET 		0x074 

#define GPK2CON_OFFSET 			0x080 
#define GPK2DAT_OFFSET 			0x084 
#define GPK2PUD_OFFSET 			0x088 
#define GPK2DRV_SR_OFFSET 		0x08C 
#define GPK2CONPDN_OFFSET 		0x090 
#define GPK2PUDPDN_OFFSET 		0x094 

#define GPK3CON_OFFSET 			0x0A0 
#define GPK3DAT_OFFSET 			0x0A4 
#define GPK3PUD_OFFSET 			0x0A8 
#define GPK3DRV_SR_OFFSET 		0x0AC 
#define GPK3CONPDN_OFFSET 		0x0B0 
#define GPK3PUDPDN_OFFSET 		0x0B4 

#define GPL0CON_OFFSET 			0x0C0 
#define GPL0DAT_OFFSET 			0x0C4 
#define GPL0PUD_OFFSET 			0x0C8 
#define GPL0DRV_SR_OFFSET 		0x0CC 
#define GPL0CONPDN_OFFSET 		0x0D0 
#define GPL0PUDPDN_OFFSET 		0x0D4 

#define GPL1CON_OFFSET 			0x0E0 
#define GPL1DAT_OFFSET 			0x0E4 
#define GPL1PUD_OFFSET 			0x0E8 
#define GPL1DRV_SR_OFFSET 		0x0EC 
#define GPL1CONPDN_OFFSET 		0x0F0 
#define GPL1PUDPDN_OFFSET 		0x0F4 

#define GPL2CON_OFFSET 			0x100 
#define GPL2DAT_OFFSET 			0x104 
#define GPL2PUD_OFFSET 			0x108 
#define GPL2DRV_SR_OFFSET 		0x10C 
#define GPL2CONPDN_OFFSET 		0x110 
#define GPL2PUDPDN_OFFSET 		0x114 

#define GPY0CON_OFFSET 			0x120 
#define GPY0DAT_OFFSET 			0x124 
#define GPY0PUD_OFFSET 			0x128 
#define GPY0DRV_SR_OFFSET 		0x12C 
#define GPY0CONPDN_OFFSET 		0x130 
#define GPY0PUDPDN_OFFSET 		0x134 

#define GPY1CON_OFFSET 			0x140 
#define GPY1DAT_OFFSET 			0x144 
#define GPY1PUD_OFFSET 			0x148 
#define GPY1DRV_SR_OFFSET 		0x14C 
#define GPY1CONPDN_OFFSET 		0x150 
#define GPY1PUDPDN_OFFSET 		0x154 

#define GPY2CON_OFFSET 			0x160 
#define GPY2DAT_OFFSET 			0x164 
#define GPY2PUD_OFFSET 			0x168 
#define GPY2DRV_SR_OFFSET 		0x16C 
#define GPY2CONPDN_OFFSET 		0x170 
#define GPY2PUDPDN_OFFSET 		0x174 

#define GPY3CON_OFFSET 			0x180 
#define GPY3DAT_OFFSET 			0x184 
#define GPY3PUD_OFFSET 			0x188 
#define GPY3DRV_SR_OFFSET 		0x18C 
#define GPY3CONPDN_OFFSET 		0x190 
#define GPY3PUDPDN_OFFSET 		0x194 

#define GPY4CON_OFFSET 			0x1A0 
#define GPY4DAT_OFFSET 			0x1A4 
#define GPY4PUD_OFFSET 			0x1A8 
#define GPY4DRV_SR_OFFSET 		0x1AC 
#define GPY4CONPDN_OFFSET 		0x1B0 
#define GPY4PUDPDN_OFFSET 		0x1B4 

#define GPY5CON_OFFSET 			0x1C0 
#define GPY5DAT_OFFSET 			0x1C4 
#define GPY5PUD_OFFSET 			0x1C8 
#define GPY5DRV_SR_OFFSET 		0x1CC 
#define GPY5CONPDN_OFFSET 		0x1D0 
#define GPY5PUDPDN_OFFSET 		0x1D4 

#define GPY6CON_OFFSET 			0x1E0 
#define GPY6DAT_OFFSET 			0x1E4 
#define GPY6PUD_OFFSET 			0x1E8 
#define GPY6DRV_SR_OFFSET 		0x1EC 
#define GPY6CONPDN_OFFSET 		0x1F0 
#define GPY6PUDPDN_OFFSET 		0x1F4 

#define ETC6PUD_OFFSET 			0x228 
#define ETC6DRV_OFFSET 			0x22C 
...
#define GPX0DRV_SR_OFFSET 		0xC0C 

#define GPX1CON_OFFSET 			0xC20 
#define GPX1DAT_OFFSET 			0xC24 
#define GPX1PUD_OFFSET 			0xC28 
#define GPX1DRV_SR_OFFSET 		0xC2C 

#define GPX2CON_OFFSET 			0xC40 
#define GPX2DAT_OFFSET 			0xC44 
#define GPX2PUD_OFFSET 			0xC48 
#define GPX2DRV_SR_OFFSET 		0xC4C 

#define GPX3CON_OFFSET 			0xC60 
#define GPX3DAT_OFFSET 			0xC64 
#define GPX3PUD_OFFSET 			0xC68 
#define GPX3DRV_SR_OFFSET 		0xC6C 
...
#define GPE2CON				(GPIO_LB_BASE + GPE2CON_OFFSET) 
#define GPE2DAT				(GPIO_LB_BASE + GPE2DAT_OFFSET)		 
#define GPE2PUD				(GPIO_LB_BASE + GPE2PUD_OFFSET)		 
#define GPE2DRV				(GPIO_LB_BASE + GPE2DRV_SR_OFFSET)
#define GPE2CONPDN			(GPIO_LB_BASE + GPE2CONPDN_OFFSET)	 
#define GPE2PUDPDN			(GPIO_LB_BASE + GPE2PUDPDN_OFFSET)	 
#define GPE3CON				(GPIO_LB_BASE + GPE3CON_OFFSET) 
#define GPE3DAT				(GPIO_LB_BASE + GPE3DAT_OFFSET)		 
#define GPE3PUD				(GPIO_LB_BASE + GPE3PUD_OFFSET)		 
#define GPE3DRV				(GPIO_LB_BASE + GPE3DRV_SR_OFFSET)
#define GPE3CONPDN			(GPIO_LB_BASE + GPE3CONPDN_OFFSET)	 
#define GPE3PUDPDN			(GPIO_LB_BASE + GPE3PUDPDN_OFFSET)	 
#define GPE4CON				(GPIO_LB_BASE + GPE4CON_OFFSET) 
#define GPE4DAT				(GPIO_LB_BASE + GPE4DAT_OFFSET)		 
#define GPE4PUD				(GPIO_LB_BASE + GPE4PUD_OFFSET)		 
#define GPE4DRV				(GPIO_LB_BASE + GPE4DRV_SR_OFFSET)
#define GPE4CONPDN			(GPIO_LB_BASE + GPE4CONPDN_OFFSET)	 
#define GPE4PUDPDN			(GPIO_LB_BASE + GPE4PUDPDN_OFFSET)	 
...
#if 0 //JNJ
#define GPG0CON				(GPIO_LB_BASE + GPG0CON_OFFSET) 
#define GPG0DAT				(GPIO_LB_BASE + GPG0DAT_OFFSET)		 
#define GPG0PUD				(GPIO_LB_BASE + GPG0PUD_OFFSET)		 
#define GPG0DRV				(GPIO_LB_BASE + GPG0DRV_SR_OFFSET)
#define GPG0CONPDN			(GPIO_LB_BASE + GPG0CONPDN_OFFSET)	 
#define GPG0PUDPDN			(GPIO_LB_BASE + GPG0PUDPDN_OFFSET)	 
#define GPG1CON				(GPIO_LB_BASE + GPG1CON_OFFSET) 
#define GPG1DAT				(GPIO_LB_BASE + GPG1DAT_OFFSET)		 
#define GPG1PUD				(GPIO_LB_BASE + GPG1PUD_OFFSET)		 
#define GPG1DRV				(GPIO_LB_BASE + GPG1DRV_SR_OFFSET)
#define GPG1CONPDN			(GPIO_LB_BASE + GPG1CONPDN_OFFSET)	 
#define GPG1PUDPDN			(GPIO_LB_BASE + GPG1PUDPDN_OFFSET)	 
#define GPG2CON				(GPIO_LB_BASE + GPG2CON_OFFSET) 
#define GPG2DAT				(GPIO_LB_BASE + GPG2DAT_OFFSET)		 
#define GPG2PUD				(GPIO_LB_BASE + GPG2PUD_OFFSET)		 
#define GPG2DRV				(GPIO_LB_BASE + GPG2DRV_SR_OFFSET)
#define GPG2CONPDN			(GPIO_LB_BASE + GPG2CONPDN_OFFSET)	 
#define GPG2PUDPDN			(GPIO_LB_BASE + GPG2PUDPDN_OFFSET)	 
#define GPG3CON				(GPIO_LB_BASE + GPG3CON_OFFSET) 
#define GPG3DAT				(GPIO_LB_BASE + GPG3DAT_OFFSET)		 
#define GPG3PUD				(GPIO_LB_BASE + GPG3PUD_OFFSET)		 
#define GPG3DRV				(GPIO_LB_BASE + GPG3DRV_SR_OFFSET)
#define GPG3CONPDN			(GPIO_LB_BASE + GPG3CONPDN_OFFSET)	 
#define GPG3PUDPDN			(GPIO_LB_BASE + GPG3PUDPDN_OFFSET)	 
#define GPICON				(GPIO_LB_BASE + GPICON_OFFSET) 
#define GPIPUD				(GPIO_LB_BASE + GPIPUD_OFFSET)			 
#define GPIDRV				(GPIO_LB_BASE + GPIDRV_OFFSET_SR)
#define GPIPUDPDN			(GPIO_LB_BASE + GPIPUDPDN_OFFSET)	 
#endif

#define GPJ0CON				(GPIO_BASE + GPJ0CON_OFFSET)	 
#define GPJ0DAT				(GPIO_BASE + GPJ0DAT_OFFSET)		 
#define GPJ0PUD				(GPIO_BASE + GPJ0PUD_OFFSET)		 
#define GPJ0DRV				(GPIO_BASE + GPJ0DRV_SR_OFFSET)
#define GPJ0CONPDN			(GPIO_BASE + GPJ0CONPDN_OFFSET)	 
#define GPJ0PUDPDN			(GPIO_BASE + GPJ0PUDPDN_OFFSET)	 
#define GPJ1CON				(GPIO_BASE + GPJ1CON_OFFSET) 
#define GPJ1DAT				(GPIO_BASE + GPJ1DAT_OFFSET)		 
#define GPJ1PUD				(GPIO_BASE + GPJ1PUD_OFFSET)		 
#define GPJ1DRV				(GPIO_BASE + GPJ1DRV_SR_OFFSET)
#define GPJ1CONPDN			(GPIO_BASE + GPJ1CONPDN_OFFSET)	 
#define GPJ1PUDPDN			(GPIO_BASE + GPJ1PUDPDN_OFFSET)	 
#define GPK0CON				(GPIO_BASE + GPK0CON_OFFSET)	 
#define GPK0DAT				(GPIO_BASE + GPK0DAT_OFFSET)		 
#define GPK0PUD				(GPIO_BASE + GPK0PUD_OFFSET)		 
#define GPK0DRV				(GPIO_BASE + GPK0DRV_SR_OFFSET)
#define GPK0CONPDN			(GPIO_BASE + GPK0CONPDN_OFFSET)	 
#define GPK0PUDPDN			(GPIO_BASE + GPK0PUDPDN_OFFSET)	 
#define GPK1CON				(GPIO_BASE + GPK1CON_OFFSET)	 
#define GPK1DAT				(GPIO_BASE + GPK1DAT_OFFSET)		 
#define GPK1PUD				(GPIO_BASE + GPK1PUD_OFFSET)		 
#define GPK1DRV				(GPIO_BASE + GPK1DRV_SR_OFFSET)
#define GPK1CONPDN			(GPIO_BASE + GPK1CONPDN_OFFSET)	 
#define GPK1PUDPDN			(GPIO_BASE + GPK1PUDPDN_OFFSET)	 
#define GPK2CON				(GPIO_BASE + GPK2CON_OFFSET)	 
#define GPK2DAT				(GPIO_BASE + GPK2DAT_OFFSET)		 
#define GPK2PUD				(GPIO_BASE + GPK2PUD_OFFSET)		 
#define GPK2DRV				(GPIO_BASE + GPK2DRV_SR_OFFSET)
#define GPK2CONPDN			(GPIO_BASE + GPK2CONPDN_OFFSET)	 
#define GPK2PUDPDN			(GPIO_BASE + GPK2PUDPDN_OFFSET)	 
#define GPK3CON				(GPIO_BASE + GPK3CON_OFFSET)	 
#define GPK3DAT				(GPIO_BASE + GPK3DAT_OFFSET)		 
#define GPK3PUD				(GPIO_BASE + GPK3PUD_OFFSET)		 
#define GPK3DRV				(GPIO_BASE + GPK3DRV_SR_OFFSET)
#define GPK3CONPDN			(GPIO_BASE + GPK3CONPDN_OFFSET)	 
#define GPK3PUDPDN			(GPIO_BASE + GPK3PUDPDN_OFFSET)	 
#define GPL0CON				(GPIO_BASE + GPL0CON_OFFSET)	 
#define GPL0DAT				(GPIO_BASE + GPL0DAT_OFFSET)		 
#define GPL0PUD				(GPIO_BASE + GPL0PUD_OFFSET)		 
#define GPL0DRV				(GPIO_BASE + GPL0DRV_SR_OFFSET)
#define GPL0CONPDN			(GPIO_BASE + GPL0CONPDN_OFFSET)	 
#define GPL0PUDPDN			(GPIO_BASE + GPL0PUDPDN_OFFSET)	 
#define GPL1CON				(GPIO_BASE + GPL1CON_OFFSET)	 
#define GPL1DAT				(GPIO_BASE + GPL1DAT_OFFSET)		 
#define GPL1PUD				(GPIO_BASE + GPL1PUD_OFFSET)		 
#define GPL1DRV				(GPIO_BASE + GPL1DRV_SR_OFFSET)
#define GPL1CONPDN			(GPIO_BASE + GPL1CONPDN_OFFSET)	 
#define GPL1PUDPDN			(GPIO_BASE + GPL1PUDPDN_OFFSET)	 
#define GPL2CON				(GPIO_BASE + GPL2CON_OFFSET)	 
#define GPL2DAT				(GPIO_BASE + GPL2DAT_OFFSET)		 
#define GPL2PUD				(GPIO_BASE + GPL2PUD_OFFSET)		 
#define GPL2DRV				(GPIO_BASE + GPL2DRV_SR_OFFSET)
#define GPL2CONPDN			(GPIO_BASE + GPL2CONPDN_OFFSET)	 
#define GPL2PUDPDN			(GPIO_BASE + GPL2PUDPDN_OFFSET)	 
#define GPY0CON				(GPIO_BASE + GPY0CON_OFFSET)	 
#define GPY0DAT				(GPIO_BASE + GPY0DAT_OFFSET)		 
#define GPY0PUD				(GPIO_BASE + GPY0PUD_OFFSET)		 
#define GPY0DRV				(GPIO_BASE + GPY0DRV_SR_OFFSET)
#define GPY0CONPDN			(GPIO_BASE + GPY0CONPDN_OFFSET)	 
#define GPY0PUDPDN			(GPIO_BASE + GPY0PUDPDN_OFFSET)	 
#define GPY1CON				(GPIO_BASE + GPY1CON_OFFSET)	 
#define GPY1DAT				(GPIO_BASE + GPY1DAT_OFFSET)		 
#define GPY1PUD				(GPIO_BASE + GPY1PUD_OFFSET)		 
#define GPY1DRV				(GPIO_BASE + GPY1DRV_SR_OFFSET)
#define GPY1CONPDN			(GPIO_BASE + GPY1CONPDN_OFFSET)	 
#define GPY1PUDPDN			(GPIO_BASE + GPY1PUDPDN_OFFSET)	 
#define GPY2CON				(GPIO_BASE + GPY2CON_OFFSET)	 
#define GPY2DAT				(GPIO_BASE + GPY2DAT_OFFSET)		 
#define GPY2PUD				(GPIO_BASE + GPY2PUD_OFFSET)		 
#define GPY2DRV				(GPIO_BASE + GPY2DRV_SR_OFFSET)
#define GPY2CONPDN			(GPIO_BASE + GPY2CONPDN_OFFSET)	 
#define GPY2PUDPDN			(GPIO_BASE + GPY2PUDPDN_OFFSET)	 
#define GPY3CON				(GPIO_BASE + GPY3CON_OFFSET)	 
#define GPY3DAT				(GPIO_BASE + GPY3DAT_OFFSET)		 
#define GPY3PUD				(GPIO_BASE + GPY3PUD_OFFSET)		 
#define GPY3DRV				(GPIO_BASE + GPY3DRV_SR_OFFSET)
#define GPY3CONPDN			(GPIO_BASE + GPY3CONPDN_OFFSET)	 
#define GPY3PUDPDN			(GPIO_BASE + GPY3PUDPDN_OFFSET)	 
#define GPY4CON				(GPIO_BASE + GPY4CON_OFFSET)	 
#define GPY4DAT				(GPIO_BASE + GPY4DAT_OFFSET)		 
#define GPY4PUD				(GPIO_BASE + GPY4PUD_OFFSET)		 
#define GPY4DRV				(GPIO_BASE + GPY4DRV_SR_OFFSET)
#define GPY4CONPDN			(GPIO_BASE + GPY4CONPDN_OFFSET)	 
#define GPY4PUDPDN			(GPIO_BASE + GPY4PUDPDN_OFFSET)	 
#define GPY5CON				(GPIO_BASE + GPY5CON_OFFSET)	 
#define GPY5DAT				(GPIO_BASE + GPY5DAT_OFFSET)		 
#define GPY5PUD				(GPIO_BASE + GPY5PUD_OFFSET)		 
#define GPY5DRV				(GPIO_BASE + GPY5DRV_SR_OFFSET)
#define GPY5CONPDN			(GPIO_BASE + GPY5CONPDN_OFFSET)	 
#define GPY5PUDPDN			(GPIO_BASE + GPY5PUDPDN_OFFSET)	 
#define GPY6CON				(GPIO_BASE + GPY6CON_OFFSET)	 
#define GPY6DAT				(GPIO_BASE + GPY6DAT_OFFSET)		 
#define GPY6PUD				(GPIO_BASE + GPY6PUD_OFFSET)		 
#define GPY6DRV				(GPIO_BASE + GPY6DRV_SR_OFFSET)
#define GPY6CONPDN			(GPIO_BASE + GPY6CONPDN_OFFSET)	 
#define GPY6PUDPDN			(GPIO_BASE + GPY6PUDPDN_OFFSET)	 

#define MP01CON_REG			__REG(GPIO_BASE + MP01CON_OFFSET)
#define MP01DAT_REG			__REG(GPIO_BASE + MP01DAT_OFFSET)		 
#define MP01PUD_REG			__REG(GPIO_BASE + MP01PUD_OFFSET)		 
#define MP01DRV_REG			__REG(GPIO_BASE + MP01DRV_SR_OFFSET)
#define MP01CONPDN_REG			__REG(GPIO_BASE + MP01CONPDN_OFFSET)	 
#define MP01PUDPDN_REG			__REG(GPIO_BASE + MP01PUDPDN_OFFSET)


#define MP02CON_REG                     __REG(GPIO_BASE + MP02CON_OFFSET)
#define MP02DAT_REG                     __REG(GPIO_BASE + MP02DAT_OFFSET)          
#define MP02PUD_REG                     __REG(GPIO_BASE + MP02PUD_OFFSET)          
#define MP02DRV_REG                     __REG(GPIO_BASE + MP02DRV_SR_OFFSET)
#define MP02CONPDN_REG                  __REG(GPIO_BASE + MP02CONPDN_OFFSET)       
#define MP02PUDPDN_REG                  __REG(GPIO_BASE + MP02PUDPDN_OFFSET)

#define MP03CON_REG                     __REG(GPIO_BASE + MP03CON_OFFSET)
#define MP03DAT_REG                     __REG(GPIO_BASE + MP03DAT_OFFSET)          
#define MP03PUD_REG                     __REG(GPIO_BASE + MP03PUD_OFFSET)          
#define MP03DRV_REG                     __REG(GPIO_BASE + MP03DRV_SR_OFFSET)
#define MP03CONPDN_REG                  __REG(GPIO_BASE + MP03CONPDN_OFFSET)       
#define MP03PUDPDN_REG                  __REG(GPIO_BASE + MP03PUDPDN_OFFSET)

#define GPX0CON				(GPIO_BASE + GPX0CON_OFFSET)	 
#define GPX0DAT				(GPIO_BASE + GPX0DAT_OFFSET)		 
#define GPX0PUD				(GPIO_BASE + GPX0PUD_OFFSET)		 
#define GPX0DRV				(GPIO_BASE + GPX0DRV_SR_OFFSET)
#define GPX1CON				(GPIO_BASE + GPX1CON_OFFSET)	 
#define GPX1DAT				(GPIO_BASE + GPX1DAT_OFFSET)		 
#define GPX1PUD				(GPIO_BASE + GPX1PUD_OFFSET)		 
#define GPX1DRV				(GPIO_BASE + GPX1DRV_SR_OFFSET)
#define GPX2CON				(GPIO_BASE + GPX2CON_OFFSET)	 
#define GPX2DAT				(GPIO_BASE + GPX2DAT_OFFSET)		 
#define GPX2PUD				(GPIO_BASE + GPX2PUD_OFFSET)		 
#define GPX2DRV				(GPIO_BASE + GPX2DRV_SR_OFFSET)
...
{
//JNJ	return (S5PC21X_GPIO *)ELFIN_GPIO_BASE;
	return (S5PC21X_GPIO *)GPIO_BASE;
}
