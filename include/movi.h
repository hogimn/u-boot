...
----->	reserved		reserved
	...
	Partition1		Partition1
*/
#define RAW_AREA_SIZE		(16 * 1024 * 1024)		// total 16MB
#define PART_SIZE_MBR		(512)			// MBR (Master Boot Record)
#define PART_SIZE_FWBL1	(8 * 1024)		// FWBL1
#define PART_SIZE_BL1		(16 * 1024)		// BL1
#define PART_SIZE_BL2		(14 * 1024 + 2 * 1024)	// BL2 + 2K signature
#define PART_SIZE_UBOOT	(512 * 1024)		// 512KB
#define PART_SIZE_ENV		CONFIG_ENV_SIZE		// 16KB
#define PART_SIZE_KERNEL	(4 * 1024 * 1024)		// 4MB
#define PART_SIZE_LOGO		(2 * 1024 * 1024)		// 2MB
