...
#define CONFIG_SM5S4210     1
#define CONFIG_DEVICE_STRING    "sm5s4210"

#define CONFIG_EVT1     1       /* EVT1 */

#define CONFIG_CMD_BDT	1 //M3 Board Test for SM5
...
//JNJ for Logo Display
//#define CFG_LCD_LMS700
#define CFG_LCD_LTE480WV
...
#define CONFIG_SYS_PROMPT              "SM5S4210 # "    /* Monitor Command Prompt       */
...
/*
 * SM5S4210 board specific data
 */

#define CONFIG_IDENT_STRING	" for SM5S4210 Android"
...
// JNJ  for SMC911X
#define CONFIG_BOOTARGS	"console=ttySAC1,115200 ip=192.168.0.165:192.168.0.160:192.168.0.1:255.255.255.0::eth0:off ethaddr=00:0b:a8:03:13:02 "
#define CONFIG_ETHADDR		    00:0b:a8:03:13:02
...
#define CONFIG_DRIVER_SMC911X_BASE  0x04001300
