...
#define CONFIG_DEVICE_STRING    "hkdkc210"
...
#define CONFIG_SYS_PROMPT              "HKDKC210 # "    /* Monitor Command Prompt       */
...
/*
 * HKDKC210 board specific data
 */

#define CONFIG_IDENT_STRING	" for HKDKC210 Android"
