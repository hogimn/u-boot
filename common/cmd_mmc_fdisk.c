...
#define        SYSTEM_PART_SIZE        524288             // 256MB
#define        USER_DATA_PART_SIZE     2097152             // 1Gb
#define        CACHE_PART_SIZE         262144              // 128MB
#else  
#define		SYSTEM_PART_SIZE		_256MB
#define		USER_DATA_PART_SIZE		_1GB
#define		CACHE_PART_SIZE			_128MB
#endif
...
#if defined(CONFIG_SM5S4210) 
	int FAT_PART_SIZE;
	int offset_fat, offset_android, offset_android_data, offset_android_cache;
	int start_fat, start_android, start_android_data, start_android_cache;
#endif
...
#if defined(CONFIG_SM5S4210) 
   FAT_PART_SIZE = (sdInfo.total_block_count-32768-SYSTEM_PART_SIZE-USER_DATA_PART_SIZE-CACHE_PART_SIZE-2);

   offset_fat = FAT_PART_SIZE;
   offset_android = SYSTEM_PART_SIZE;
   offset_android_data = USER_DATA_PART_SIZE;
   offset_android_cache = CACHE_PART_SIZE;

   start_android = 32768;
   start_android_data = start_android + SYSTEM_PART_SIZE;
   start_android_cache = start_android_data + USER_DATA_PART_SIZE;
   start_fat = start_android_cache + CACHE_PART_SIZE;
#endif

///////////////////////////////////////////////////////////
#if defined(CONFIG_SM5S4210)
	block_start = start_android;
	block_offset = offset_android;
#else
...
#if defined(CONFIG_SM5S4210)
	block_start = start_android_data;
	block_offset = offset_android_data;
#else
...
///////////////////////////////////////////////////////////	
#if defined(CONFIG_SM5S4210)
	block_start = start_android_cache;
	block_offset = offset_android_cache;
#else
	block_start += block_offset;
...
///////////////////////////////////////////////////////////	
#if defined(CONFIG_SM5S4210)
	block_start = start_fat;
	block_offset = offset_fat;
#else
	block_start += block_offset;
